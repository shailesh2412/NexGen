...
/* Slides data
-------------------------------------------------------------- */
const truckImg = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/1780138/truck-car.png',
roadsterImg = './image/roadster-car.png',
truckFloorImg = 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/1780138/truck-floor.png',
roadsterFloorImg = './image/w.png';
ferrari = './image/f.png';
macleran = './image/m.png';
...
function SlideAside(props) {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("span", null, "NEXGEN"), /*#__PURE__*/
